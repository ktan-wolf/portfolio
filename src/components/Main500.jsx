    ...
    <>
      {loading ? (
        ...
        <div className="relative flex flex-col gap-10 bg-[#262626] pt-3">
          <div className='bg-black h-52 flex items-center mx-2 place-content-center gap-8 rounded-2xl'>
          ...
          <div className="bg-black flex items-center mx-2  gap-8 rounded-2xl text-gray-500 mb-15">
