        ...
        <div className="relative flex flex-col gap-10 bg-[#262626] pt-3">
          <div className='bg-black h-52 flex items-center mx-40 pl-20 gap-8 rounded-2xl'>
            ...
            <div className="text-gray-500 flex flex-col gap-5">
              <p>Ketan Kumar</p>
              <div className="border-2 text-gray-500 rounded-md p-1">Software Develope\</div>
            </div>
          </div>
          ...
          <div className="bg-black flex items-center mx-40 px-10 gap-8 rounded-2xl text-gray-500 mb-15">
