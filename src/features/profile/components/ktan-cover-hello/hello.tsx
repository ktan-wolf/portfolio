...
import { KtanWordmark } from "@/components/brand/ktan-wordmark";
...
const layers = ["hello", "ktan-wordmark"] as const;
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {layers[currentIndex] === "ktan-wordmark" && (
            <motion.div
            ...
            >
              <KtanWordmark className="h-16 sm:h-20" />
            </motion.div>
          )}
